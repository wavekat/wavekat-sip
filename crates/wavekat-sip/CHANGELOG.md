...
- report presented certificate names bare ([#60](https://github.com/wavekat/wavekat-sip/pull/60))

## [0.2.4](https://github.com/wavekat/wavekat-sip/compare/v0.2.3...v0.2.4) - 2026-09-21
...
- advertise the real transport on calls, not just REGISTER ([#56](https://github.com/wavekat/wavekat-sip/pull/56))

## [0.2.2](https://github.com/wavekat/wavekat-sip/compare/v0.2.1...v0.2.2) - 2026-09-20

### Added

- implement SIP over TCP ([#54](https://github.com/wavekat/wavekat-sip/pull/54))

## [0.2.1](https://github.com/wavekat/wavekat-sip/compare/v0.2.0...v0.2.1) - 2026-07-04

### Added

- send 100 Trying and 180 Ringing for inbound calls ([#51](https://github.com/wavekat/wavekat-sip/pull/51))

## [0.2.0](https://github.com/wavekat/wavekat-sip/compare/v0.1.2...v0.2.0) - 2026-07-03

### Added

- [**breaking**] Opus SDP negotiation with pinned re-offers ([#49](https://github.com/wavekat/wavekat-sip/pull/49))

## [0.1.2](https://github.com/wavekat/wavekat-sip/compare/v0.1.1...v0.1.2) - 2026-06-30

### Added

- expose Call::peer_uri for attended Refer-To target
- attended call transfer via REFER + Replaces (RFC 3891)
